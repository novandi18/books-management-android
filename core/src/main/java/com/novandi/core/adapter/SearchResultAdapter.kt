...
import com.novandi.core.databinding.ItemSearchResultBinding
...
class SearchResultAdapter : RecyclerView.Adapter<SearchResultAdapter.BookViewHolder>() {
    ...
    inner class BookViewHolder : RecyclerView.ViewHolder(binding.root) {
        fun bind(data: BookEntity) {
            with(binding) {
                tvTitleSearchResult.text = data.title
                tvAuthorSearchResult.text = data.author
                ...
                cvSearchResult.setOnClickListener {
